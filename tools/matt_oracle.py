...
factually. `--report` prints one such survey outright:

  C. MISSABLE -- our `MISSABLE_LOCATIONS` flags against his Event-scope slots tagged `missable`.
...
def main(argv=None):
    ...
    if args.report:
        ...
        print("== C. MISSABLE (report-only, no gate) ==")
