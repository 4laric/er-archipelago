...
Runs the closed-loop coverage gate (greenfield/eldenring_gf/coverage.py) in STATIC full-pool REPORT
...
suppression / region-consistency holes, with the four historically-known failure classes called out
...
GF_PKG = os.path.join(REPO, "greenfield", "eldenring_gf")
