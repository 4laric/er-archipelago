...
BINDINGS = (
    (7771048, 12017100, "Ainsel River", "western side of nokstella eternal city"),
    (7771144, 12017997, "Ainsel River", "putrid tree spirit in the grand cloister"),
    (7772686, 1038517400, "Altus Plateau", "erdtree gazing hill"),
    (7772741, 1039517400, "Altus Plateau", "altus highway junction"),
    (7772843, 1042507020, "Altus Plateau", "ulcerated tree spirit south of outer wall phantom tree"),
    (7772848, 1042547400, "Altus Plateau", "dominula windmill village"),
    (7774304, 1041547400, "Altus Plateau", "minor erdtree altus plateau"),
    (7773048, 1049377020, "Caelid", "road to redmane castle"),
    (7773085, 1050397100, "Caelid", "sellia town of sorcery"),
    (7774502, 1051437020, "Caelid", "path to the bestial sanctum"),
    (7900003, 520160, "Caelid", "putrid tree spirit in war dead catacombs"),
    (7774471, 1049557800, "Consecrated Snowfield", "north east of the consecrated snowfield"),
    (7771484, 13007980, "Crumbling Farum Azula", "dragon temple rooftop"),
    (7771485, 13007990, "Crumbling Farum Azula", "dragon temple site of grace"),
    (7771026, 11007993, "Altus Plateau", "ulcerated tree spirit in leyndell royal capital"),
    (7773920, 11007990, "Altus Plateau", "valiant gargoyle south of the west capital rampart"),
    (7770583, 400191, "Limgrave", "roderika has moved to roundtable hold"),
    (7772951, 1046367100, "Limgrave", "entrance to fort haight"),
    (7772629, 1037507100, "Liurnia of the Lakes", "southwest of the ravine veiled village"),
    (7774156, 1035507300, "Liurnia of the Lakes", "caria manor past the room containing the manor upper level"),
    (7771552, 14007990, "Liurnia of the Lakes", "academy of raya lucaria west of the courtyard"),
    (7773061, 1049527800, "Mountaintops of the Giants", "forbidden lands near the black blade kindred"),
    (7773181, 1052537800, "Mountaintops of the Giants", "south of the giant s gravepost"),
    (7773818, 520180, "Mountaintops of the Giants", "giants mountaintop catacombs"),
    (7771148, 12027040, "Siofra River", "worshipper s woods"),
    (7770831, 10007195, "Limgrave", "uncerated tree spirit in the lower area of the castle"),
    (7770884, 10007730, "Limgrave", "secluded cell site of grace"),
    (7772904, 1044327020, "Limgrave", "weeping peninsula near the path to castle morne"),
)
REFUSED = {
    "7772845": "one 2x source row cannot select AP slot 1",
    "7772846": "one 2x source row cannot select AP slot 2",
    "7772895": "no distinct source row selects this second two-seed lot",
    "7772896": "no distinct source row selects this second two-seed lot",
    "7773714": "the source does not distinguish this Roderika/Lake-Facing Cliffs check",
}
