...
BASELINE_TOTAL_LOCATIONS = 5033   # PREVIOUS: 5098 (the worldless-singles cull, Alaric 2026-08-19: 86 map-encoded ground-lot flags with no world reference under a zero-blind-map census left the pool -- gen_data._WORLDLESS_SINGLES) # PREVIOUS: 5088 (the full-census regen restored ten m21_02 Rada rows the blind census had condemned) # PREVIOUS: 5212 (#330 removed the 124 worldless Rada Fruit rows: 55 with no world reference in any datamine + 69 m21 bundle-stack rows -- see gen_data._RADA_WORLDLESS and test_gf_rada_fruit_worldless.py) # PREVIOUS: 4931 (#191 widened the co-check allowlist from 5 hand-verified families to the datamine_flag_lots policy: +281 sibling checks, each the same physical acquisition as its primary) # PREVIOUS: 4932 # PREVIOUS: 4916 # 4915 + 1: the Great Rune of the Unborn co-check (flag 197 lot 10181, #426): a co-check is the SAME physical acquisition as its primary and inherits its tags.
