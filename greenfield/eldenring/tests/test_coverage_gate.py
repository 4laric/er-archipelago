...
# 4931 -> 4932: #1543 restores the MSB/EMEVD-proven Furnace Visage sibling.
# 4932 -> 4926 (2026-09-25, #1522/#1521): six phantom rows retired -- two common-event lots
# (Cracked Pot x15, Perfume Bottle x5) nothing awards and four flag_tile-only map lots -- via
# greenfield/tombstones.tsv, so no other ap id moved.
BASELINE_TOTAL_LOCATIONS = 4926
                                  # Previous 4941 - 10: #1515/#1518 dropped four unplaceable map lots and
                                  # six "About ..." tutorial rows (was +5 physical, Briars, and
                                  # seven Somber recoveries, #1437)
