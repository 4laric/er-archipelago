...
class AccessDispositionTests(unittest.TestCase):
    ...
    def test_current_census_is_complete_with_encoded_key_gate_option_rows(self):
        ...
        self.assertEqual(value["dispositions_total"], value["checks_total"] + 16)
        self.assertEqual(value["by_disposition"]["region_sufficient"], 4)
        self.assertEqual(value["by_disposition"]["encoded"], 17)
        ...
        self.assertEqual(value["by_risk"]["critical"]["encoded"], 17)
        ...
        self.assertEqual(value["with_access_claim"], 45)
        self.assertEqual(value["without_access_claim"], 4894)
