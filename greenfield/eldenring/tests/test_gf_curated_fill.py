...
from worlds.eldenring.location_tags import LOCATION_TAGS, TAG_COUNTS  # noqa: E402
from worlds.eldenring.contract import (  # noqa: E402
    BIG_TICKET_TYPES, BIG_TICKET_EXCLUDE_TAGS, IMPORTANT_LOCATION_TYPES, is_big_ticket,
    BIG_TICKET_LOCATIONS,
)
from worlds.eldenring.features.curated_fill import select_priority  # noqa: E402
from worlds.eldenring.features.important_locations import _VALID  # noqa: E402
from worlds.eldenring.features.big_ticket_locations import BigTicketLocations  # noqa: E402
...
def test_vocabulary_shared_with_important_locations():
    ...
    assert set(BigTicketLocations.default) == {"MajorBoss", "Remembrance", "GreatRune"}
