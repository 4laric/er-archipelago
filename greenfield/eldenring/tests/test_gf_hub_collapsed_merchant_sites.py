...
the 19 `Roundtable Hold ::` rows whose seller stands in more than one region were in logic AT SPAWN
...
class CollapsedSiteTable(unittest.TestCase):
    ...
    def test_the_patches_sixteen_have_exactly_the_three_reviewed_regions(self):
