...
Run:  python -m pytest greenfield/eldenring/tests/test_gf_region_artifact_oracle.py
  or: python greenfield/eldenring/tests/test_gf_region_artifact_oracle.py
"""
import csv
import glob
