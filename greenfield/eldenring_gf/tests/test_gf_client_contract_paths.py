...
Run:  python -m pytest greenfield/eldenring_gf/tests/test_gf_client_contract_paths.py
  or: python greenfield/eldenring_gf/tests/test_gf_client_contract_paths.py   (unittest fallback)
"""
