...
Run:  python -m pytest greenfield/eldenring_gf/tests/test_gf_region_provenance_oracle.py
  or: python greenfield/eldenring_gf/tests/test_gf_region_provenance_oracle.py
"""
import csv
