...
CHOICE = {
    ...
    "num_regions_rune_source": {"regions":0,"pool":1},
    ...
    "grace_sweep": {"off":0,"complement":1,"full":2},
    "dungeon_sweep": {"none":0,"minidungeons":1,"all":2,"bosses":3},
    "location_pool": {"all":0,"trimmed":1,"lean":2},
    "derandomize_questlines": {"off":0,"links_only":1,"full":2},
...
DEFAULT = {
    ...
    "num_regions_rune_source":"regions","random_start_region":"off","dungeon_sweep":"none",
    "grace_sweep":"off","completion_scaling":"off","accessibility":"full",
